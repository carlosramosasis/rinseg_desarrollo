 ...
 * {@link FragmentInspeccionIncidenciaDetalle1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentInspeccionIncidenciaDetalle1#newInstance} factory method to
...
public class FragmentInspeccionIncidenciaDetalle1 extends Fragment {
    ...
    public static FragmentInspeccionIncidenciaDetalle1 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_inspeccion_detalle2_incidente_detalle1, container, false);
    ...
    public void onResume() {
        super.onResume();
        activityMain.toolbarInspeccionDet.setTitle(R.string.title_rop);
    ...
    private void setUpActions() {
        btnLevantarIncidente.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(View v){
                activityMain.replaceFragment(new FragmentLevantarIncidencia(),true,0,0,0,0);
            }
